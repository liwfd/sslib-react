...
module.exports = {
    ...
    entry: {
        ...
        vendor: ['lodash', 'sslib-react', 'antd-mobile', 'react', 'react-dom', 'react-redux', 'history', 'react-router', 'rc-animate', 'superagent', 'superagent-jsonp', 'js-cookie', 'react-router-redux'],
    },
    output: {
        // The build folder.
        path: paths.appBuild,
                ...
                oneOf: [
                    ...
                    },
                    {
                        ...
                        include: [
                            ...
                            path.resolve(__dirname, '../../../antd-mobile/'),  // antd-mobile的svg文件目录
